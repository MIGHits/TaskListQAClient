    ...
    NavHost(
        ...
        composable<TasksScreen> {
            TaskScreen(
                ...
                toFullTaskScreen = { navController.navigate(FullTaskScreen) })
        }
        composable<CreateTaskScreen> {
            CreateTaskScreen(onBackClick = { navController.navigateUp() })
        }
        composable<FullTaskScreen> {
            FullTaskScreen(onBackAction = { navController.navigateUp() })
        }
    }
}